...
api_key = '8f3cfa9d73b53754d3004d0c188c3835'
...
def home():
    ...
    url = 'https://api.themoviedb.org/3/trending/all/day?api_key=8f3cfa9d73b53754d3004d0c188c3835'
    ...
    for result in data['results']:
        title = ""
        poster_path = ""
        title, poster_path = GetTitle(result)
        movie_cards[title] = 'https://image.tmdb.org/t/p/w500'+poster_path
    print(movie_cards)
    return render_template('home.html', movie_cards=movie_cards, suggestions=suggestions)
